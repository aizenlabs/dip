		...
		<div id="content" class="site-content" role="main">
			...
			<article id="post-0" class="post not-found">
				...
				<div class="entry-content">
					...
					<?php if ( dip_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'dip' ), convert_smilies( ':)' ) ) . '</p>';
