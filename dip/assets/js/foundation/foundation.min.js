...
;(function ($, window, document, undefined) {
  ...
  var Orbiting = function(el, settings) {
    ...
    self._goto = function(next_idx, start_timer) {
      ...
      slides_container.trigger('orbiting:before-slide-change');
      ...
      var callback = function() {
        var unlock = function() {
          ...
          slides_container.trigger('orbiting:after-slide-change',[{slide_number: idx, total_slides: slides.length}]);
    ...
    self.init = function() {
      ...
      if (settings.swipe) {
        container.on('touchstart.fndtn.orbiting', function(e) {
        ...
        .on('touchmove.fndtn.orbiting', function(e) {
          if (!e.touches) { e = e.originalEvent; }
        ...
        .on('touchend.fndtn.orbiting', function(e) {
          container.data('swipe-transition', {});
          e.stopPropagation();
        });
      }
      container.on('mouseenter.fndtn.orbiting', function(e) {
        if (settings.timer && settings.pause_on_hover) {
          self.stop_timer();
        }
      })
      .on('mouseleave.fndtn.orbiting', function(e) {
      ...
      slides_container.trigger('orbiting:ready');
    };
  ...
  var Timer = function(el, settings, callback) {
    ...
    this.start = function() {
      ...
      el.trigger('orbiting:timer-started')
    };
    ...
    this.stop = function() {
      ...
      el.trigger('orbiting:timer-stopped');
    };
  };
  ...
  Foundation.libs.orbiting = {
    ...
    init: function (scope, method, options) {
      ...
      if ($(scope).is('[data-orbiting]')) {
        var $el = $(scope);
        var opts = self.data_options($el);
        new Orbiting($el, $.extend({},self.settings, opts));
      }

      $('[data-orbiting]', scope).each(function(idx, el) {
        var $el = $(el);
        var opts = self.data_options($el);
        new Orbiting($el, $.extend({},self.settings, opts));
      });
